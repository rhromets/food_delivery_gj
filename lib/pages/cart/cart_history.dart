...
class CartHistory extends StatelessWidget {
        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (cartController) {
            return cartController.getCartHistoryList().isNotEmpty
                ? _getCartHistoryPage(context, itemsPerOrder,
                    getCartHistoryList, listCounter, cartOrderTimeToList)
                : _getEmptyPage(context);
          })
        ],
      ),
    );
  ...
  SizedBox _getEmptyPage(BuildContext context) {
    return SizedBox(
  ...
  Expanded _getCartHistoryPage(
      BuildContext context,
      List<int> itemsPerOrder,
      List<CartModel> getCartHistoryList,
      int listCounter,
      List<String> Function() cartOrderTimeToList) {
    return Expanded(
      child: Container(
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _orderAgainButton(
                                    cartOrderTimeToList, getCartHistoryList, i),
                              ],
                            ),
                          ),
                        ],
